...
public class UserInterface {
    ...
    private void createLoginPage(){
        ...
        TextField userName = new TextField("ankit@123.in");
        userName.setPromptText("Type your user name here");
        PasswordField password = new PasswordField();
        password.setText("cbc123");
    ...
    private void createHeaderBar(){
        ...
        Image image = new Image("C:\\Users\\Admin\\IdeaProjects\\Ecommerce\\src\\img.png");
        ...
        signInButton = new Button("Sing In");
        ...
        placeOrderButton.setOnAction(new EventHandler<ActionEvent>() {
            @Override
            public void handle(ActionEvent actionEvent) {
                // need list of customer and products
                if (itemsInCart==null){
                    // please select a product first to place order
                    showDialog("Please add some products in the cart first to place order");
                    return;
                }
                if (loggedInCustomer==null){
    ...
    private void createFooterBar(){
        ...
        addtoCartButton.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent actionEvent) {
                ...
                showDialog("Selected Item has been added to the Cart!");
